...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#1a1a1a]" style={{ fontFamily: "'Inter', 'Helvetica Neue', Arial, sans-serif" }}>
      {/* Announcement bar */}
      <div className="bg-[#2d5a27] text-white text-xs text-center py-2 px-4 tracking-wide">
        🌿 Flat 25% OFF on orders above ₹499 &nbsp;|&nbsp; Free shipping on orders above ₹199
      </div>
      ...
      <header className="border-b border-gray-100 px-6 md:px-12 py-4 flex items-center justify-between sticky top-0 bg-white z-50">
        ...
        <nav className="hidden md:flex gap-8 text-sm text-gray-600 font-medium">
          ...
          <a href="#" className="hover:text-[#2d5a27] transition-colors">Bundles</a>
          <a href="#" className="hover:text-[#2d5a27] transition-colors">About</a>
          <a href="#" className="hover:text-[#2d5a27] transition-colors">Recipes</a>
        </nav>
        <div className="flex items-center gap-5">
          <button className="text-sm text-gray-600 hover:text-[#2d5a27] hidden md:block">Login</button>
          <button className="relative" aria-label="Shopping bag">
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 bg-[#2d5a27] text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center font-bold">
                {cartCount}
              </span>
            )}
          </button>
      ...
      <main className="px-6 md:px-12 pb-16 max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[48%] flex flex-col gap-5 pt-2">
            ...
            {/* Title */}
            <div>
              <p className="text-xs text-gray-400 tracking-widest uppercase mb-1 font-medium">Traditional Pickle</p>
            ...
            <div className="flex gap-3">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${purchaseType === 'subscribe' ? 'border-[#2d5a27]' : 'border-gray-300'}`}>
                    {purchaseType === 'subscribe' && <div className="w-2 h-2 rounded-full bg-[#2d5a27]" />}
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${purchaseType === 'onetime' ? 'border-[#2d5a27]' : 'border-gray-300'}`}>
                    {purchaseType === 'onetime' && <div className="w-2 h-2 rounded-full bg-[#2d5a27]" />}
                  </div>
                </div>
            ...
            <div className="flex gap-3 items-center">
              ...
              <button
                ...
                className="flex-1 bg-[#2d5a27] hover:bg-[#1f3f1b] text-white font-semibold py-3.5 rounded-full text-sm transition-colors"
              >
            ...
            {/* Buy Now */}
            <button className="w-full border-2 border-[#2d5a27] text-[#2d5a27] font-semibold py-3 rounded-full text-sm hover:bg-[#f0f7ee] transition-colors">
              Buy Now
            </button>
      ...
      <section className="bg-[#fbfaf6] pt-16 md:pt-24">
        ...
        <div className="mx-auto flex max-w-[680px] flex-col gap-5 px-6 py-10 md:flex-row md:items-center md:justify-between md:py-16">
          ...
          <a href="https://wa.me/919999999999" className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#2d5a27] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1f3f1b]"><span aria-hidden="true">💬</span> WhatsApp par poochho</a>
        </div>
      </section>
    </div>
  )

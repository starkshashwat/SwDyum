...
function Icon({ name, size = 20 }) {
  ...
  const paths = {
    ...
    leaf: <><path d="M11 20A7 7 0 019.8 6.9C15.5 4.9 17 3.5 19 1c1 2 2 4.5 2 8 0 5.5-4.8 11-10 11z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></>,
    ...
    chili: <><path d="M9 11c-3 0-6 2.5-6 7 0 2 1 4 3 4 6 0 12-6 13-13"/><path d="M19 9a4 4 0 00-6-5"/><path d="M19 9c1.5-.5 2.5-2 2-4"/></>,
    scissors: <><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><line x1="20" y1="4" x2="8.12" y2="15.88"/><line x1="14.47" y1="14.48" x2="20" y2="20"/><line x1="8.12" y1="8.12" x2="12" y2="12"/></>,
    droplet: <path d="M12 2.69l5.66 5.66a8 8 0 11-11.31 0z"/>,
    jar: <><path d="M8 2h8l2 6H6l2-6z"/><rect x="6" y="8" width="12" height="12" rx="2"/></>,
    refresh: <><path d="M3 12a9 9 0 109-9"/><path d="M3 4v5h5"/></>,
    tree: <><path d="M12 22v-7"/><path d="M12 15l4-4a5 5 0 10-8 0z"/><path d="M12 9V2"/><circle cx="12" cy="6" r="4"/></>,
  };

        ...
        <>
          ...
          >
            ...
            <div className="wa-modal-header">
              ...
              <h2 className="wa-modal-title">Log in to Checkout</h2>
              <p className="wa-modal-subtitle">
                {step === 1 ? 'Enter your WhatsApp number to quickly sign in and track your order.' : 'We sent a 6-digit code to your WhatsApp.'}
              </p>
            </div>
